...
const makeTwo = () => {
  ...
  resultTwo.textContent = difference; //Ваш код
};
...
const makeThree = () => {
  ...
  resultThree.textContent = product; //Ваш код
};
...
const makeFour = () => {
  ...
  resultFour.textContent = quotient; //Ваш код
};
...
const makeFive = () => {
  ...
  resultFive.textContent = result; //Ваш код
};
...
const makeSix = () => {
  ...
  resultSix.textContent = result; //Ваш код
};
...
const makeSeven = () => {
  ...
  resultSeven.textContent = remainder; //Ваш код
};
...
const makeEight = () => {
  ...
  resultEight.textContent = remainder; //Ваш код
};
...
const makeNine = () => {
  ...
  resultNine.textContent = remainder; //Ваш код
};
...
const makeTen = () => {
  ...
  resultTen.textContent = char; //Ваш код
};
...
const makeTwelve = () => {
  ...
  resultTwelve.textContent = combinedStr; //Ваш код
};
...
const makeThirteen = () => {
	...
	resultThirteen.textContent = length; //Ваш код
};
...
const makeFourteen = () => {
  ...
  resultFourteen.textContent = lowerCaseStr; //Ваш код
};
...
const makeFifteen = () => {
  ...
  resultFifteen.textContent = upperCaseStr; //Ваш код
};
...
const makeSixteen = () => {
  ...
  resultSixteen.textContent = substring; //Ваш код
};
...
const makeSeventeen = () => {
  ...
  resultSeventeen.textContent = substring; //Ваш код
};
...
const makeEighteen = () => {
  ...
  resultEighteen.textContent = replacedStr; //Ваш код
};
...
const makeNineteen = () => {
	const str = 'Hello, world!';
	const substring = str.substr(7, 6);
	resultNineteen.textContent = substring; //Ваш код
};
...
const makeTwenty = () => {
  ...
  resultTwenty.textContent = maxNumber; //Ваш код
};
...
const makeTwentyOne = () => {
  ...
  resultTwentyOne.textContent = randomNumber;//Ваш код
};
...
const makeTwentyTwo = () => {
  ...
  resultTwentyTwo.textContent = minNumber;//Ваш код
};
...
const makeTwentyThree = () => {
  ...
  resultTwentyThree.textContent = result;//Ваш код
};
...
const makeTwentyFour = () => {
  ...
  resultTwentyFour.textContent = minNumber; //Ваш код
};
...
const makeTwentyFive = () => {
  ...
  resultTwentyFive.textContent = maxNumber; //Ваш код
};
...
const makeTwentySix = () => {
  ...
  resultTwentySix.textContent = randomNumber; //Ваш код
};
...
const makeTwentySeven = () => {
  ...
  resultTwentySeven.textContent = randomNumber;//Ваш код
};
...
const makeTwentyEight = () => {
	const roundedNumber = Math.ceil(4.47);
  resultTwentyEight.textContent = roundedNumber;//Ваш код
};
...
const makeTwentyNine = () => {
  ...
  resultTwentyNine.textContent = squareRoot; //Ваш код
};
...
const makeThirty = () => {
  ...
  resultThirty.textContent = squareRoot; //Ваш код
};
